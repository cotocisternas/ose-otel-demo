...
- [ ] 18-01-PLAN.md — Wave 1: Write scripts/capture-screenshots.mjs (unified Playwright capture script) + scripts/package.json (Playwright 1.59.1); all logic in script per D-S1/D-S2/D-S3/D-S4 (SCAP-01/02/03)
