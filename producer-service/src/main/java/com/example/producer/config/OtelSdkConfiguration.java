...
public class OtelSdkConfiguration {
     ...
     * (mirror of the LOG-03 inline-assign pattern at line ~246 for
     ...
     * The shutdown sequence does NOT use this field either — the
     * {@link CloseableOpenTelemetrySdk} holder bean (WR-01 fix) takes the SDK as
     * a constructor parameter directly.
     *
